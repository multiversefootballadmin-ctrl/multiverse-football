    ...
    <div className="min-h-screen bg-[#0E0F12] text-zinc-100 font-sans pb-24 relative overflow-hidden">
      ...
      <main className="relative z-10 max-w-4xl mx-auto px-6 pt-16 space-y-16">
        ...
        <section className="space-y-8 text-lg md:text-xl font-light text-zinc-300 leading-relaxed">
          ...
          <p>
            By mapping kinesthetic data, spatial processing, and situational leverage, we built the <strong>WIF Score</strong>—the first algorithmic bridge that translates Soccer telemetry directly into American Football value. 
          </p>
          ...
          <div className="bg-[#121316] border border-orange-500/30 p-8 md:p-12 mt-16 shadow-2xl relative overflow-hidden group">
            ...
            <h3 className="font-mono text-sm uppercase tracking-widest text-orange-500 font-bold mb-4">The Ultimate Endgame</h3>
            <p className="text-lg text-white font-medium leading-relaxed">
              The rankings are just phase one. Our endgame is to launch the first true Cross-Sport Fantasy Engine, where you can draft a real Premier League winger to act as your Flex WR for the week. <br/><br/>Welcome to the Multiverse.
            </p>
          </div>
        </section>
